...
backtest = GoogleFinanceBacktest(instruments=codes, initialCash=10000, year=2015, csvDirs="./googlefinance", downloadFiles=False)
backtest.attachAlgorithm(DonchianTradingAlgorithm(backtest.getFeed(), backtest.getBroker(), 12, 26, 0.03))
backtest.run()
